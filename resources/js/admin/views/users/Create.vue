            ...
            <div class="col-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        ...
                        <router-link :to="{path: '/usuarios'}" class="btn btn-sm btn-secondary float-right"><i class="fas fa-angle-double-left" aria-hidden="true">&nbsp;</i> Regresar</router-link>
                    </div>
                    <!-- /.card-header -->
                    <!-- <div class="card-body">
                    </div> -->
                                ...
                                <form-wizard
                                    ...
                                    <!-- <tab-content title="Datos del Usuario"  icon="ti-user" :before-change="validateTab1">
                                        <div class="card card-default card-default">
                                            <div class="card-header">
                                                <h3 class="card-title"><i class="fas fa-user-plus">&nbsp;</i> Datos del Usuario</h3>
                                            </div> -->
                                            <!-- /.card-header -->                  
                                            <!-- <div class="card-body"> -->
                                                <!-- <img-profile
                                    ...
                                    <!-- <tab-content title="Clave del Usuario" icon="ti-key" :before-change="validateTab2"> -->
                                        ...
                                        <!-- <div class="card card-default card-default">
                                            <div class="card-header">
                                                <h3 class="card-title"><i class="fas fa-key">&nbsp;</i> Clave del Usuario</h3>
                                            </div>
                                            <div class="card-body">  -->
                                                <!-- /.card-header -->
                                                <!-- <div class="form-group row">
                                    ...
                                    <tab-content title="Rol del Usuario" icon="ti-shield" :before-change="validateTab3">
                                        ...
                                        <div class="card card-default card-default">
                                            <div class="card-header">
                                                <h3 class="card-title"><i class="fas fa-user-shield">&nbsp;</i> Rol del Usuario</h3>
                                            </div>
                                            <div class="card-body">
                                                <!-- /.card-header -->                  
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control" v-model="role.id" @change="onChange(role.id)">
                                                            <option value="0">Seleccione un Tipo de Rol</option>
                                                ...
                                                <!-- <div v-if="role.id > 0" class="callout callout-danger">
                                                    <h5>{{ roles.display_name[role.id-1] }}</h5>

                                                    <p>{{ roles.description[role.id-1] }}</p>
                                                </div> -->
                                            </div>
                                            <!-- /.card-body -->
                                        </div>
    ...
    methods:{
        ...
        validateTab1:function() {
          return new Promise((resolve, reject) => {
            setTimeout(() => {
                var url = `/api/auth/usuarios/validar_data`;
                axios.post(url,{
                   'name': this.user.name,
        ...
        validateTab2:function() {
            return new Promise((resolve, reject) => {
                if(this.validPass == true || this.user.password == ''){  
                        setTimeout(() => {
                            var url = `/api/auth/usuarios/validar_pass`;
                            axios.post(url,{
        ...
        storeUser(){
            if(this.divisa > 0){
                ...
                setTimeout(() => {
                    axios.post(url,{
                        'name' : this.name,
                        'type_document' : this.category_id,
                        'num_document' : this.code,
                        'email' : this.description,
                        'num_phone': this.currentUser.id,
                        'address':this.photos,
                        'password': this.user.password,
                        'role': this.role.name,
        ...
        onChange(role){
            ...
            this.role = '';
            if(role > 0){
                this.role = me.roles.find(elemento => elemento.id == role)
